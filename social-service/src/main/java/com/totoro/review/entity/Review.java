...
public class Review {
    ...
    /**
     * References listing_cache table — a local materialised view of core-service listings.
     * Populated/updated via Kafka events (listing-created, listing-updated, listing-deleted).
     */
